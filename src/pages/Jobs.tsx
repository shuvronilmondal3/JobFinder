  ...
  const jobs = [
    {
      ...
      salary: "INR 130,000 - INR 160,000",
      description:
        "We're looking for a talented Senior Software Engineer to join our growing team. In this role, you'll develop innovative solutions and lead technical initiatives.",
      posted: "2 days ago",
      type: "Full-time",
      requirements: [
    ...
    },
    {
      ...
      description:
        "Lead product development from concept to launch, working closely with engineering, design, and marketing teams to deliver exceptional user experiences.",
      posted: "3 days ago",
      type: "Full-time",
      requirements: [
    ...
    },
    {
      ...
      description:
        "Design and implement CI/CD pipelines, infrastructure as code, and cloud-native solutions to support our growing platform.",
      posted: "5 days ago",
      type: "Full-time",
      requirements: [
        "AWS certification",
    ...
    },
    {
      ...
      description:
        "Build modern web applications using the latest technologies and frameworks to deliver exceptional user experiences.",
      posted: "1 day ago",
      type: "Full-time",
      requirements: [
      ...
      <div className="flex flex-col space-y-6">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="relative flex-grow">
            ...
            <Input className="pl-10 py-6" placeholder="Location or remote" />
          </div>
